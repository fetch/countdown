...
(function() {
    ...
    counter: function() {
      ...
      return this.each(function() {
        ...
        if (counter) {
          ...
          return $(this).data('counter', new Counter(this, options));
        }
      });
    }
  });
  ...
  Counter = (function() {
    ...
    function Counter(elem, options) {
      this.jq_elem = $(elem);
      this.value = 0;
      this.options = $.extend({}, Counter.defaults, this.jq_elem.data(), options);
      this.buildHtml();
      this.parseOptions();
    }

    Counter.prototype.parseOptions = function() {
    ...
    Counter.prototype.buildHtml = function() {
      var digits, i;
      i = 0;
      digits = [];
    ...
    Counter.prototype.animateTo = function(value) {
    ...
    Counter.prototype.setOption = function(option, value) {
